...
export default function Footer() {
  ...
  const services = [
    ...
    { name: 'Shower Screens', href: '/services/showers' },
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6 flex items-center space-x-2">
              <div className="w-12 h-12 bg-white rounded flex items-center justify-center text-primary font-bold text-xl">
                PJ
              </div>
              <span className="text-2xl font-bold text-white">P&J Glass</span>
            </Link>
            <p className="text-white/80 mb-6 max-w-md">
              Transforming spaces with premium glass solutions. Expert design, 
              precision fabrication, and flawless installation across Romford 
              and Greater London.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 mt-1 flex-shrink-0 text-secondary" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <div>
                  <a href="tel:01708123456" className="hover:text-secondary transition-colors">
                    01708 123 456
                  </a>
                  <p className="text-sm text-white/60">Mon-Fri 8am-6pm, Sat 9am-4pm</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:info@pjglass.co.uk" className="hover:text-secondary transition-colors">
                  info@pjglass.co.uk
                </a>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 pt-12 border-t border-white/10">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-sm text-white/60">Trade Accredited</div>
          </div>
        </div>
      </div>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm">
              © {currentYear} P&J Glass Ltd. All rights reserved. Company No. 12345678
            </p>
